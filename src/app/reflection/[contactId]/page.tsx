...
import { AsiheneReflection } from "@/components/reflection/AsiheneReflection";
  ...
  return (
    <main className="min-h-screen bg-paper text-deep-teal">
      ...
      <section className="max-w-3xl mx-auto px-6 pb-16">
        <AsiheneReflection data={data} shareToken={t!} contactId={contactId} />
      </section>
